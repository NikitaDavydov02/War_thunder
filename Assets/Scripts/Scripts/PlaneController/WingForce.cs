...
public class WingForce : MonoBehaviour, IForce
{
    ...
    public void CountForce(out List<Vector3> CurrentForceVectors, out List<Vector3> AbsolutePointsOfForceApplying)
    {
        ...
        //Debug.Log("Cx: " + Cx);
        //Debug.Log("Cy: " + Cy);
        float lift = MainWeatherManager.AirDensity * area * flowVelocityInSelfCoordinatesWithoutTangent.sqrMagnitude * Cy;
        float drag = MainWeatherManager.AirDensity * area * flowVelocityInSelfCoordinatesWithoutTangent.sqrMagnitude * Cx;
